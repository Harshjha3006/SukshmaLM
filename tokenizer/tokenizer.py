...
class LLMTokenizer: 
    ...
    def decode_skip_pad(self, tokens: list[int]) -> str: 
        """
        Decodes a list of numerical tokens back into string form
        while skipping padding tokens
        Args: 
            tokens (list[int]): the list of input tokens
        Returns: 
            Decoded form of the tokens
        ...
        tokens_to_be_decoded = [token for token in tokens if (token != self.PAD_TOKEN_ID)]
    ...
    def decode_skip_special(self, tokens: list[int]) -> str: 
        """
        Decodes a list of numerical tokens back into string form
        while skipping special and padding tokens
        Args: 
            tokens (list[int]): the list of input tokens
        Returns: 
            Decoded form of the tokens
        ...
        # create a new tokens list with no special tokens 
        tokens_to_be_decoded = [token for token in tokens if (token != self.special_token_idMap.values() and token != self.PAD_TOKEN_ID)]
